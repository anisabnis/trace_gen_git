...
f = open("/mnt/nfs/scratch1/asabnis/trace_gen/" + t_file + "/cache_state_" + str(obj_mod) + "_8.txt", "w")
...
# f = open("/mnt/nfs/scratch1/asabnis/trace_gen/" + t_file + "/pop_sd_" + str(obj_mod) + "_8.txt", "w")
...
# f = open("/mnt/nfs/scratch1/asabnis/trace_gen/" + t_file + "/joint_dst_" + str(obj_mod) + "_8_Test.txt", "w")
