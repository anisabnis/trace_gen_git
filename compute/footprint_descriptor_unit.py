...
f = open("/mnt/nfs/scratch1/asabnis/trace_gen/" + t_file + "/footprint_desc_4000_" + str(obj_mod) + ".txt", "w")
...
# f = open("./" + t_file + "/one_hits_" + str(obj_mod) + ".txt", "w")
...
# f = open("./" + t_file + "/iat_sz_" + str(obj_mod) + ".txt", "w")
# j = 0
# for iat in iat_sz:
#     f.write(str(iat) + "\n")
...
# j = 0
# f = open("./" + t_file + "/iat_pop_" + str(obj_mod) + ".txt", "w")
# for iat in iat_pop:
#     f.write(str(iat) + "\n")
