...
if BR == "r":
    f = open("results/" + str(tc) + "/simulations/generated_climb_" +  str(cache_size) + "_" + str(typ) + ".txt", "w")
else:
    f = open("results/" + str(tc) + "/simulations/byte_generated_climb_" +  str(cache_size) + "_" + str(typ) + ".txt", "w")
