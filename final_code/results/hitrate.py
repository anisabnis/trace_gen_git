...
#f = open(dir + "/generated.stats3000000000_pop_init.txt", "r")
f = open(dir + "/generated.stats1000000000_bytes.txt", "r")
generated = []
...
if mod_u < 100:
    f = open(dir + "/original.stats1000000000_" + str(mod_u) + ".txt", "r")
else:
...
plt.plot(generated, label="generated_byte")
