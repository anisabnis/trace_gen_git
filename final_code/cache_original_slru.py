...
if mod_u > 100:
    f = open("results/" + str(tc) + "/simulations/original_s4lru_"  + str(cache_size) + ".txt", "w")
else:
    f = open("results/" + str(tc) + "/simulations/original_s4lru_"  + str(cache_size) + "_" + str(mod_u) + ".txt", "w")
